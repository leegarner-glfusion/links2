...
// TODO: Temporarily sharing the table keys & names with the Links plugin.
...
// Plugin info
Links\Config::set('pi_display_name', 'Links v2');
Links\Config::set('pi_version', '3.0.0');
Links\Config::set('gl_version', '1.7.8');
Links\Config::set('pi_url', 'https://www.glfusion.org');

// Configuration items to be created
Links\Config::set('ext_rel', 'noopener noreferrer noindex nofollow');
