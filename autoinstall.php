...
require_once __DIR__ . '/links2.php';
...
$INSTALL_plugin['links'] = array(
    ...
    array(
        'type' => 'table',
        'table' => $_TABLES['linkcategories'],
        'sql' => $_SQL['linkcategories'],
    ),
    array(
        'type' => 'table',
        'table' => $_TABLES['links'],
    ...
    array(
        'type' => 'table',
        'table' => $_TABLES['linksubmission'],
        'sql' => $_SQL['linksubmission'],
    ),
    array(
        'type' => 'group',
        'group' => 'links Admin',
        'desc' => 'Users in this group can administer the Links plugin',
    ...
    array(
        'type' => 'feature',
        'feature' => 'links.edit',
        'desc' => 'Ability to edit links',
        'variable' => 'edit_feature_id',
    ),
    array(
        'type' => 'feature',
        'feature' => 'links.moderate',
        'desc' => 'Ability to moderate the Links Plugin',
        'variable' => 'moderate_feature_id',
    ),
    array(
        'type' => 'feature',
        'feature' => 'links.submit',
        'desc' => 'Ability to submit Links',
